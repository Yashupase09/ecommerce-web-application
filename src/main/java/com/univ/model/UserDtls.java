...
public class UserDtls {
	...
	public UserDtls(int id, String name, String mobileNumber, String email, String address, String city, String state,
			String pincode, String password, String profileImage, String role, Boolean isEnable, Boolean accountNonLocked, int failedAttempt, Date lockTime, String resetToken) {
		super();
		this.id = id;
		this.name = name;
